...
router.post('/create', jsonParser, (req, res) => {
  writeLog("Crear Meta", req.body, req.query.usuario_id);
  const payload = req.body;
  models.metas.create(
    payload
  ).then((result) => {
...
router.post('/update', jsonParser, (req, res) => {
  writeLog("Actualizar Meta", req.body, req.query.usuario_id);
  const id = req.body.id;
  const payload = req.body;
...
router.post('/destroy', jsonParser, (req, res) => {
  writeLog("Eliminar Meta", req.body, req.query.usuario_id);
  const payload = req.body;
