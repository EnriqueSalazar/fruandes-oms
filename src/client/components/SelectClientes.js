...
SelectClientes = reduxForm({
  form: 'selectClientes'  // a unique identifier for this form
})(SelectClientes)

// Decorate with connect to read form values
const selector = formValueSelector('selectClientes') // <-- same as form name
SelectClientes = connect(
  state => {
